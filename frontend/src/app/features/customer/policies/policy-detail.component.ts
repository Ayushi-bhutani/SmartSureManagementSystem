      ...
      <div class="container" *ngIf="policy">
        <div class="page-header">
          ...
          <div class="header-content">
            <h1>{{ policy.insuranceSubtype?.name || 'Insurance Policy' }}</h1>
        ...
        <div class="content-grid">
          ...
          <mat-card class="main-card">
            ...
            <h2>{{ policy.insuranceSubtype?.name || 'Insurance Policy' }}</h2>
            
            <div class="key-info">
              <div class="info-item">
                <span class="label">Coverage (IDV)</span>
                <span class="value primary">₹{{ policy.idv }}</span>
              </div>
              <div class="info-item">
                ...
                <div class="tab-content">
                  ...
                  <div class="detail-row">
                    ...
                    <div class="detail-info">
                      ...
                      <span class="value">{{ policy.insuranceSubtype?.name }}</span>
                    </div>
                  </div>
                  ...
                  <div class="detail-row">
                    ...
                    <div class="detail-info">
                      ...
                      <span class="value">{{ policy.createdAt | date:'medium' }}</span>
                    </div>
                  </div>
                  ...
                  <div class="detail-row">
                    ...
                    <div class="detail-info">
                      ...
                      <span class="value">{{ policy.approvedClaimsCount }}</span>
                    </div>
                  </div>
                </div>
              </mat-tab>
                  ...
                  <div class="coverage-info">
                    ...
                    <ul class="coverage-list">
                      <li>
                        ...
                        <span>Full coverage up to ₹{{ policy.idv }}</span>
                      </li>
                      <li>
                        <mat-icon>check_circle</mat-icon>
...
export class PolicyDetailComponent implements OnInit {
  ...
  downloadPolicy(): void {
    this.toastr.info('Policy download feature coming soon!');
  }
