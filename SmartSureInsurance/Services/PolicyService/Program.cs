...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Policy Management Service for SmartSure Insurance"
    });
...
{
    throw new InvalidOperationException("Database connection string 'PolicyDb' is not configured.");
}
...
Console.WriteLine("Swagger URL: https://localhost:5002/swagger");
Console.WriteLine("========================================\n");
